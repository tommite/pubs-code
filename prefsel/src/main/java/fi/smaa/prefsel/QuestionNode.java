...
public class QuestionNode implements Node {
	...
	private AnswerNode createAnswerNode(int a1, int a2) {
		...
		PreferenceRelation compRes = prefModel.compare(impacts.getRow(a1), impacts.getRow(a2));
		...
		return new AnswerNode(newQ.toArray(new Question[0]), a1, newPrefs, prefModel, impacts);
	}
